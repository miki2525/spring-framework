...
@WebMvcTest(PaymentRestAdapter.class)
...
class PaymentRestAdapterTest {
    ...
    static class TestConfig {
        ...
        public RestExceptionResponseBuilder responseBuilder(MessageSource messageSource) {
            return new RestExceptionResponseBuilder(messageSource, TEST_TIME_PROVIDER);
        }
    ...
    void beforeEach() {
        ...
        when(mapper.toDto(any(PaymentDomain.class))).then(toDto);
    }
